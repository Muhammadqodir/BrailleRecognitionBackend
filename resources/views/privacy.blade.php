...
<head>
    ...
    <title>Privacy Policy - Braille Recognition</title>
    <meta content="Privacy Policy for BrailleRecognition app" name="description">
    <meta content="Privacy Policy - Braille Recognition" property="og:title">
    <meta content="Privacy Policy for BrailleRecognition app" property="og:description">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.1.3/dist/css/bootstrap.min.css"
        integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <meta content="https://braillerecognition.alfocus.uz/images/banner_2.png" property="og:image">
    <meta property="og:type" content="website">

    <meta content="width=device-width, initial-scale=1" name="viewport">

    <link href="./res/thrive-template.webflow.d602b637b.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/" rel="preconnect">
    <link href="https://fonts.gstatic.com/" rel="preconnect" crossorigin="anonymous">
    <script src="./res/webfont.js" type="text/javascript"></script>
    <link rel="stylesheet" href="./res/device.css">
    <link rel="stylesheet" href="./res/css" media="all">
    ...
    <link href="https://braillerecognition.alfocus.uz/images/logo_new.png" rel="shortcut icon" type="image/x-icon">
    <link href="https://braillerecognition.alfocus.uz/images/logo_new.png" rel="apple-touch-icon">
    <style>
        body {
...
<body>
    <div class="page-wrapper">
        <nav data-w-id="398f822d-d7ae-bf3b-539b-fdeedbd81689" class="navigation"
            ...
            <div class="nav-wrapper" style="max-width: 800px;">
                <a href="{{ route('home') }}" style="text-decoration: none;">
                    <h4>Braille Recognition</h4>
                </a>
                <div class="nav-menu">
                    <a href="https://buymeacoffee.com/braillerecognition" class="nav-link">Donate</a>
                    <a href="mailto:mqodir777@gmail.com" class="nav-link">Contact Us</a>
                    <a href="https://onelink.to/vjyqau" target="_blank" style="text-decoration: none;"
                ...
                <div class="nav-burger">
                    <div data-is-ix2-target="1" class="nav-lottie" data-w-id="398f822d-d7ae-bf3b-539b-fdeedbd81697"
                        data-animation-type="lottie"
                        data-src="https://cdn.prod.website-files.com/65bf7d3d6bb1c09b8e01a7d0/65bf98d3d599ba7badd96611_lottieflow-menu-nav-09-000000-easey.json"
                        data-loop="0" data-direction="1" data-autoplay="0" data-renderer="svg"
                        data-default-duration="2.5" data-duration="0">
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="container" style="max-width: 900px;">
                <div class="custom-card" style="padding: 48px; margin-bottom: 40px;">
                    ...
                    <div class="privacy-content">
                        <p>
                            <strong>Braille Recognition</strong> is provided by <strong>AL-FOCUS TECH LLC</strong> at no cost and is intended for use as is.
                        ...
                        <p>
                            ...
                            policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with
                        ...
                        <p>
                            ...
                            identifiable information. The information that we request will be retained on your device and is not collected by us in any way.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to
                        ...
                        <p>
                            ...
                            identifiable information from children under 13 years of age. In the case we discover that a child under 13 has provided
            ...
            <div class="container">
                <div class="footer-wrapper">
                    <div class="footer-left">
                        <div class="footer-brand">Braille Recognition</div>
                        <div class="footer-description">Empowering accessibility through AI technology</div>
                    </div>
                    <div class="footer-right">
                        <a href="/" class="footer-link">Home</a>
                        <a href="/privacy" class="footer-link">Privacy Policy</a>
                        <a href="mailto:info@alfocus.uz" class="footer-link">Contact</a>
                    </div>
                </div>
                <div class="footer-bottom">
                    <div class="footer-copyright">© 2026 AL-FOCUS TECH LLC. All rights reserved.</div>
                </div>
            </div>
        </footer>
    </div>

    <script src="./res/jquery-3.5.1.min.dc5e7f18c8.js" type="text/javascript"></script>
    <script src="./res/webflow.142103ecd.js" type="text/javascript"></script>
</body>
